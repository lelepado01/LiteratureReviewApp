...
use general_memos::general_memo_data::MemoData;
...
fn App(cx: Scope) -> Element {
    ...
    let papermemo_data = PaperMemoData::new(cx);
    ...
    cx.render(rsx!(
        ...
        match page.get() {
            ...
            AppPage::PaperMemos => create_paper_memos_page(cx, papermemo_data),
